...
def fetch_code_time():
    return httpx.get(
        "https://gist.githubusercontent.com/Sanksu/05162ee00bd2a93c4d0e7b3f5c173e74/raw/"
    )
...
def fetch_douban():
    entries = feedparser.parse("https://www.douban.com/feed/people/226575739/interests")["entries"]
    return [
        {
            "title": item["title"],
